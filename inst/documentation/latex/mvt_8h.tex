...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void F77\_\-NAME() mvtdst (int $\ast$ {\em n}, int $\ast$ {\em nu}, double $\ast$ {\em lower}, double $\ast$ {\em upper}, int $\ast$ {\em infin}, double $\ast$ {\em corr}, double $\ast$ {\em delta}, int $\ast$ {\em maxpts}, double $\ast$ {\em abseps}, double $\ast$ {\em releps}, double $\ast$ {\em error}, double $\ast$ {\em value}, int $\ast$ {\em inform})}}
