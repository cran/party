...
\item 
double \hyperlink{Convenience_8c_a2}{C\_\-Test\-Statistic} (const SEXP linexpcov, const int type, const double tol)
\item 
double \hyperlink{Convenience_8c_a3}{C\_\-Conditional\-Pvalue} (const double tstat, SEXP linexpcov, const int type, double tol, int $\ast$maxpts, double $\ast$releps, double $\ast$abseps)
\item 
SEXP \hyperlink{Convenience_8c_a4}{R\_\-get\_\-response} (SEXP learnsample)
\item 
void \hyperlink{Convenience_8c_a5}{R\_\-set\_\-response} (SEXP learnsample, SEXP y)
\end{CompactItemize}
...
\begin{center}
\leavevmode
\includegraphics[width=167pt]{Convenience_8c_a3_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=267pt]{Convenience_8c_a2_cgraph}
\end{center}
\end{figure}
...
Referenced by R\_\-set\_\-response().\hypertarget{Convenience_8c_a5}{
...
\begin{center}
\leavevmode
\includegraphics[width=126pt]{Convenience_8c_a5_cgraph}
\end{center}
\end{figure}
