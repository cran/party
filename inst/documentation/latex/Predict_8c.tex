...
\item[Date]2007-09-27 16:24:46 +0200 (Thu, 27 Sep 2007) \end{Desc}
\end{Desc}
...
\item[Parameters:]
\begin{description}
\item[{\em forest}]a list of trees \item[{\em where}]list (length b) of integer vectors (length n) containing terminal node numbers \item[{\em weights}]list (length b) of bootstrap case weights \item[{\em newinputs}]an object of class `Variable\-Frame' \item[{\em mincriterion}]overwrites mincriterion used for tree growing \item[{\em oobpred}]a logical indicating out-of-bag predictions \end{description}
\end{Desc}
