...
\begin{center}
\leavevmode
\includegraphics[width=174pt]{Convenience_8h__dep__incl}
\end{center}
\end{figure}
\subsection*{Functions}
\begin{CompactItemize}
\item 
void \hyperlink{Convenience_8h_8d5dcca68051449e29f3b857d375c4a0}{C\_\-Lin\-Stat\-Exp\-Cov} (const double $\ast$x, const int p, const double $\ast$y, const int q, const double $\ast$weights, const int n, const int cexpcovinf, SEXP expcovinf, SEXP ans)
\item 
void \hyperlink{Convenience_8h_f39bdd14f23726fdd6bf74888ffbf920}{C\_\-Lin\-Stat\-Exp\-Cov\-MPinv} (SEXP linexpcov, double tol)
\item 
void \hyperlink{Convenience_8h_b3f97b0fb03b3610cadeda2f36b68772}{C\_\-MLinear\-Statistic} (SEXP linexpcov, SEXP Score\-Matrix, SEXP ans)
\item 
double \hyperlink{Convenience_8h_26159cd74cebf8ff7073ff588864e9ab}{C\_\-Test\-Statistic} (const SEXP linexpcov, const int type, const double tol)
\item 
double \hyperlink{Convenience_8h_a1bfc91db235a3a166a39ed1e0a224d7}{C\_\-Conditional\-Pvalue} (const double tstat, SEXP linexpcov, const int type, double tol, int $\ast$maxpts, double $\ast$releps, double $\ast$abseps)
\end{CompactItemize}
...
\begin{center}
\leavevmode
\includegraphics[width=167pt]{Convenience_8h_a1bfc91db235a3a166a39ed1e0a224d7_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=159pt]{Convenience_8h_8d5dcca68051449e29f3b857d375c4a0_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=208pt]{Convenience_8h_f39bdd14f23726fdd6bf74888ffbf920_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=267pt]{Convenience_8h_26159cd74cebf8ff7073ff588864e9ab_cgraph}
\end{center}
\end{figure}
