...
\item 
void \hyperlink{IndependenceTest_8c_a2}{C\_\-Independence\-Test} (const SEXP x, const SEXP y, const SEXP weights, SEXP linexpcov, SEXP varctrl, SEXP ans)
\item 
SEXP \hyperlink{IndependenceTest_8c_a3}{R\_\-Independence\-Test} (SEXP x, SEXP y, SEXP weights, SEXP linexpcov, SEXP varctrl)
\item 
...
\begin{center}
\leavevmode
\includegraphics[width=219pt]{IndependenceTest_8c_a4_cgraph}
\end{center}
\end{figure}
...
Definition at line 264 of file Independence\-Test.c.
...
\begin{center}
\leavevmode
\includegraphics[width=321pt]{IndependenceTest_8c_a3_cgraph}
\end{center}
\end{figure}
