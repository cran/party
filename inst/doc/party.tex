...
+         i$nodeID), xlab = i$psplit$variableName, ylab = "Statistic", 
+         ylim = c(0, 10), cex.axis = cex, cex.lab = cex, 
+         cex.main = cex)
...
+     pard.pull + aulo.albi + troc.terr + alop.cune + pard.mont + 
+     alop.acce + alop.fabr + arct.peri ~ herbs + reft + 
+     moss + sand + twigs + water, controls = ctree_control(teststat = "maxabs", 
...
+     pard.mont + alop.acce + alop.fabr + arct.peri ~ herbs + 
+     reft + moss + sand + twigs + water, data = spider, 
